use array_trait::{Array, IntoArray};

use crate::{util::ArrayBuffer, Bulk, FromBulk, LimitToBulk, StaticBulk};
    ...
    I: Bulk
{
    ...
    /// ```
    #[inline]
    pub fn into_remainder(mut self) -> Option<core::array::IntoIter<I::Item, N>>
    {
        self.into_iter().into_remainder()
    }

    pub fn collect_with_remainder<C>(self) -> (C, Option<core::array::IntoIter<I::Item, N>>)
    where
        C: FromBulk<I::Item, Self::Length>
    {
        let buffer
    }
}
    ...
    [(); M/N]:
{
    ...
    {
        self.into_iter().array_chunks().next_chunk().unwrap()
    }
}
...
impl<I, const N: usize> LimitToBulk for ArrayChunks<I, N>
where
    I: Bulk
{
...
mod iter
{
    use crate::{util::ArrayBuffer, Bulk};

    pub struct CollectWrapper<'a, I, const N: usize>
    where
        I: Iterator
    {
        bulk: I,
        rem: &'a mut ArrayBuffer<I::Item, N>
    }

    impl<'a, I, const N: usize> Iterator for CollectWrapper<'a, I, N>
    where
        I: Iterator
    {
        type Item;
